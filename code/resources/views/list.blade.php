        ...
        <table class="layui-table">
            ...
            @foreach($data['list'] as $item)
                <tr>
                    ...
                    <td>{{$item['uid']}}</td>
                    <td>
                        <button type="button" class="layui-btn layui-btn-sm" onclick="view({{$item['file_id']}})">浏览
                        </button>
                        <button type="button" class="layui-btn layui-btn-sm" onclick="edit({{$item['file_id']}})">编辑
                        </button>
                    </td>
                </tr>
            @endforeach
