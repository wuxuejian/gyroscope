...
class SystemCrudFieldService extends BaseService
{
     ...
     * @return mixed
     */
    public function fieldByListCache(array|int $crudId, array $fields, int $isForm = 1)
    {
        return Cache::tags(SystemCrudService::TAG_NAME)->remember(__FUNCTION__ . '_' . md5(json_encode([$crudId, $fields, $isForm])), null, function () use ($crudId, $fields, $isForm) {
            return $this->dao->fieldByList($crudId, $fields, $isForm);
        });
    }
}
