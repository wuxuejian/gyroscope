    ...
    <section class="section">
        <div class="server"  ref="mianscroll">
            <el-form :model="form" :rules="rules" ref="ruleForm" label-width="120px">
                <p class="tip">数据库信息</p>
                <el-form-item label="数据库用户名:" prop="dbUser" class="label" :error="errorMsg.db_name">
                    <el-input v-model="form.dbUser" placeholder="请输入数据库用户名"></el-input>
                </el-form-item>
                <el-form-item label="数据库密码:" prop="dbPwd" class="label">
                    <el-input v-model="form.dbPwd" placeholder="请输入数据库密码"></el-input>
                </el-form-item>
                <el-form-item label="数据库名:" prop="dbName" class="label">
...
{{--                        <el-radio label="file" name="cache_type" id="cache_type1">文件缓存</el-radio>--}}
                ...
                <el-form-item label="数据库密码:" prop="rbPwd" class="label" v-if="form.cacheDriver === 'redis'" :error="errorMsg.redis_pwd">
            ...
            data() {
                ...
                return {
                    ...
                    rules:{
                        ...
                        rbPwd:[{ required: true, message: '请输入redis数据库密码', trigger: 'blur' },],
